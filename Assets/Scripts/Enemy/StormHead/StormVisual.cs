...
{
    [SerializeField] private StormAI _stormAI;
    [SerializeField] private StormHP _enemyEntity;
    ...
    public void TriggerAttackAnimationTurnOff()
    {
        ...
        Debug.Log("PolygonCollider turned off");
    }

    public void TriggerAttackAnimationTurnOn()
    {
        _enemyEntity.PolygonColliderTurnOn();
        Debug.Log("PolygonCollider turned on");
    }
